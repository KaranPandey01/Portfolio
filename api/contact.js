...
<div class="wrap">
  <div class="header"><div class="logo">KP<span>/</span>SYS</div></div>
  <div class="tag">NEW_CONTACT_SUBMISSION</div>
  <h2>You got a message 🎉</h2>
  <p class="sub">Received at ${timestamp} IST</p>
  <div class="field"><div class="field-label">Name</div><div class="field-val">${name}</div></div>
  <div class="field"><div class="field-label">Email</div><div class="field-val"><a href="mailto:${email}">${email}</a></div></div>
  <div class="field"><div class="field-label">Opportunity Type</div><div class="field-val">${subject}</div></div>
  ${company ? `<div class="field"><div class="field-label">Company</div><div class="field-val">${company}</div></div>` : ''}
  <div class="field"><div class="field-label">Message</div><div class="field-val message-val">${message}</div></div>
  <div class="footer">Reply to ${name} at ${email}</div>
</div></body></html>`,
    });
...
<style>
  ...
  .rkey{font-size:10px;color:#5a6a82;text-transform:uppercase;letter-spacing:0.08em;display:block;margin-bottom:3px}
  .rval{font-size:13px;color:#dde4ee}
...
<div class="wrap">
  ...
  <p class="body-text">Thanks for reaching out! I've received your message and will get back to you — usually <strong>within 24 hours</strong>.</p>
  <p class="body-text">Here's a copy of what you sent:</p>
  <hr class="divider">
  <div class="recap-label">Your submission</div>
  <div class="recap-box">
    <div class="recap-row"><span class="rkey">Name</span><span class="rval">${name}</span></div>
    <div class="recap-row"><span class="rkey">Email</span><span class="rval">${email}</span></div>
    <div class="recap-row"><span class="rkey">Type</span><span class="rval">${subject}</span></div>
    ${company ? `<div class="recap-row"><span class="rkey">Company</span><span class="rval">${company}</span></div>` : ''}
    <div class="recap-row"><span class="rkey">Message</span><span class="rval msg">${message}</span></div>
  </div>
  <hr class="divider">
  <p class="body-text">Feel free to reach me directly at <a href="mailto:karanpandey569@gmail.com">karanpandey569@gmail.com</a> or on <a href="https://linkedin.com/in/karanpandey">LinkedIn</a>.</p>
  <div class="sign-name">Karan Pandey</div>
  <div class="sign-title">Backend Engineer · SRM Delhi NCR · B.Tech CSE '27</div>
  <div class="footer">© 2026 Karan Pandey · karanpandey569@gmail.com</div>
</div></body></html>`,
    });
